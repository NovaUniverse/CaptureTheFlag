...
public class NovaCaptureTheFlag extends JavaPlugin implements Listener {
	...
	public void onEnable() {
		...
		if (NovaCoreGameEngine.getInstance().getRequestedGameDataDirectory() != null) {
			mapFolder = new File(NovaCoreGameEngine.getInstance().getRequestedGameDataDirectory().getAbsolutePath() + File.separator + "CaptureTheFlag" + File.separator + "Maps");
			worldFolder = new File(NovaCoreGameEngine.getInstance().getRequestedGameDataDirectory().getAbsolutePath() + File.separator + "CaptureTheFlag" + File.separator + "Worlds");
		}
